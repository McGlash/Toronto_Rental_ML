...
function createHeatmap(){
  ...
  var CrimeLastMonth = "../data/CrimeLastMonth.json"

  //var url = "http://127.0.0.1:5000/CrimeLastMonth";
  d3.json(CrimeLastMonth, function(fullcrime){
...
function createChoroplethMap(type='choropleth-income'){
  ...
  var FSA_income_age_geojson = "../static/js/FSA_income_age_geojson"
  // FSA Layer
  var FSA = new L.LayerGroup();
...
// var firstID = "c_7219930311"
// var secondID = "c_7219999552"
// var thirdID = "c_7219992729"
...
// d3.selectAll("#similarRentals").appendHTML('<span id="c"></span>')

// function oneSimilarPosting(){
// d3.selectAll("#similarRentals").html("");
//     d3.selectAll("#similarRentals").append("h3").text(firstSuggestionTitle).classed('card-title', true);
//     d3.selectAll("#similarRentals").append("p").text(" ").classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(`Price: $ ${firstSuggestionPrice}`).classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(`Furnished: ${firstSuggestionFurnished}`).classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(`Pet Friendly: ${firstSuggestionPetFriendly}`).classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(`Rental Type: ${firstSuggestionRental_type}`).classed('card-text', true);
//     d3.selectAll("#similarRentals").select("p").html(`Source: <a target="_blank" href="${firstSuggestionUrl}">${element.target.options.icon.options.source}</a>`).classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(`Postal Code: ${firstSuggestionPostal_code}`).classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(`Publised On: ${firstSuggestionPost_published_date}`).classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(`Description: ${firstSuggestionDescription}`).classed('card-text', true);
//     d3.selectAll("#similarRentals").append("p").text(` `).classed('card-text', true);
// };